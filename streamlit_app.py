...
def calculate_combustion_parameters(Flame_Thermal_Output, XH2):
    ...
    CO2 = (48083.30 + 74352.21990073 * Flame_Thermal_Output - 1185046.15095059 * XH2 
    ...
    Total_Boundary_Heat_Flux = (0 + 1588.44 * Flame_Thermal_Output - 483.70 * XH2 
    ...
    Heat_Release = (0 + 3305.10 * Flame_Thermal_Output - 791.35 * XH2 
    ...
    NOx = (0.00 + (-2.84579658) * Flame_Thermal_Output + 20.12910846 * XH2 
        + (-1.37452773) * (Flame_Thermal_Output ** 2) + (-7.19582609) * (Flame_Thermal_Output * XH2) 
        + 33.84552102 * (XH2 ** 2))
    
    Flame_Surface_Area = (1.52259958e-5 * Flame_Thermal_Output + 7.09019888e-4 * XH2 
    ...
    Radiation_Heat_Flux = (0 + 46.41 * Flame_Thermal_Output + 529.73 * XH2 
        - 9.89 * (Flame_Thermal_Output ** 2) + 66.98 * (Flame_Thermal_Thermal_Output * XH2) 
